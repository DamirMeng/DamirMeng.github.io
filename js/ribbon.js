        ...
        function p() {
            ...
            function i() {
                t.pos.x = Math.random() * n,
                    ...
                    t.alpha = .1 + Math.random() * r.clearOffset,
                    t.scale = .1 + .3 * Math.random(),
                    t.speed = Math.random(),
                    "random" === r.color ? t.color = "rgba(" + Math.floor(255 * Math.random()) + ", " + Math.floor(255 * Math.random()) + ", " + Math.floor(255 * Math.random()) + ", " + Math.random().toPrecision(2) + ")" : t.color = r.color
            }
            t.pos = {},
                i(),
                this.draw = function () {
                    t.alpha <= 0 && i(),
                        ...
                        t.alpha -= 5e-4,
                        e.beginPath(),
                        e.arc(t.pos.x, t.pos.y, t.scale * r.radius, 0, 2 * Math.PI, !1),
                        e.fillStyle = t.color,
                        e.fill(),
                        e.closePath()
                }
            ...
            init: function () {
                try {
                    this._canvas = document.createElement("canvas"),
                        ...
                        this._canvas.style["z-index"] = "-100",
                        this._onResize(),
...
new Ribbons({
    ...
    colorBrightness: "50%",
    colorAlpha: .9,//带子的宽度
    colorCycleSpeed: 5,//带子颜色渐变的速度
    verticalPosition: "random",
    horizontalSpeed: 200,//速度
    ribbonCount: 3,
    strokeSize: 0,
    parallaxAmount: -.2,
    animateSections: !0
